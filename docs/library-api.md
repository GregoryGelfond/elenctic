...
release that changes only its patch number will not remove one, change its signature, or
alter what it means. It may still fix a defect, and a fix changes behaviour; what it
