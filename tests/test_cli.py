...
_SAID_ABOUT_A_WHOLE_RUN: dict[ErrorKind, str] = {
    ...
    ErrorKind.CONTAINMENT: "containment error: the reason nothing ran\n",
...
_HEADING: dict[tuple[ErrorKind, Scope], str] = {
    ...
    (ErrorKind.CONTAINMENT, Scope.CASE): "CONTAINMENT ERROR —",
    ...
    (ErrorKind.CONTAINMENT, Scope.CORPUS): "containment error:",
