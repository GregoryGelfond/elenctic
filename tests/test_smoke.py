...
def test_package_imports() -> None:
    ...
    # one place — `elenctic.__version__`, which the build backend reads and which every published
    # statement of the version is checked against — and restating it here made a fourth statement
    # of it whose only effect was that cutting a release edited a test named for something else.
