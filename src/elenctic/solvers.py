...
That boundary is narrower than "the only module that touches clingo": others read with clingo's
parser or build and inspect its symbols, which is as pure as building a tuple. Only this module
